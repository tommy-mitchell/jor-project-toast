...
![Image showing a textarea and set of radio buttons, along with a “Pop Toast!” radio button](./playground.png)
...
![Screen recording showing how a demo Toast component can be edited using the playground](./toast-exercise-2-demo.gif)
...
![Several toasts popping up, one after another](./poppin-toasts.gif)
...
![Screen recording showing toast messages popping up when “Pop Toast!” is clicked](./toast-exercise-3-demo.gif)
